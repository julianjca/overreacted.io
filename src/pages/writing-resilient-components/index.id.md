---
title: Menulis Komponen yang Elastis
date: '2019-03-16'
spoiler: Empat prinsip yang akan mengaturmu ke jalur yang benar
---

Ketika orang pertama belajar React, mereka biasa menanyakan style guides. Itu adalah ide yang baik untuk memiliki aturan yang konsisten pada setiap proyek, beberapa dari aturan itu dibuat semaunya dan React tidak memiliki opini kuat terhadap aturan tersebut.

Kamu dapat menggunakan tipe sistem yang berbeda, deklarasi fungsi biasa ataupun arrow function, mengurutkan props berdasarkan abjad atau di urutan yang kamu suka.

Fleksibilitas ini memperbolehkan [integrasi React](https://reactjs.org/docs/add-react-to-a-website.html) ke proyek dengan konvensi yang sudah ada. Namun itu juga mengundang debat yang tidak ada habisnya.

**Ada beberapa prinsip desain yang setiap komponen harus ikuti. Tapi saya tidak bepikir bahwa style guides mengikuti prinsip itu dengan baik. Kita akan membicarakan style guides, dan lalu [melihat prinsip yang benar-benar berguna](#writing-resilient-components).**

---

## Jangan Bingung dengan Masalah yang Imajiner

Sebelum kita berbicara mengenai prinsip desain komponen, saya ingin mengatakan beberapa hal mengenai style guides. Ini bukan opini yang populer tapi seseorang harus mengatakannya!
